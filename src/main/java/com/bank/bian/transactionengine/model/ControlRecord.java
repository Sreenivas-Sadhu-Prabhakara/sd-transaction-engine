package com.bank.bian.transactionengine.model;
...
/**
 * The BIAN control record for this service domain: "Transaction Ledger Operating Session".
 *
 ...
 * to its asset type (Transaction Ledger). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Transaction Ledger Operating Session";
